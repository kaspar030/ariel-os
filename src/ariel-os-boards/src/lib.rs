...
cfg_if::cfg_if! {
    ...
    "seeedstudio-xiao-esp32-s3")] { include!("seeedstudio-xiao-esp32-s3.rs"); } else if
    #[cfg(context = "seeedstudio-xiao-esp32c6")] {
    include!("seeedstudio-xiao-esp32c6.rs"); } else if #[cfg(context =
    "seeedstudio-xiao-nrf52840-plus")] { include!("seeedstudio-xiao-nrf52840-plus.rs"); }
    else if #[cfg(context = "st-b-l475e-iot01a")] { include!("st-b-l475e-iot01a.rs"); }
    else if #[cfg(context = "st-nucleo-c031c6")] { include!("st-nucleo-c031c6.rs"); }
    else if #[cfg(context = "st-nucleo-f042k6")] { include!("st-nucleo-f042k6.rs"); }
    else if #[cfg(context = "st-nucleo-f303re")] { include!("st-nucleo-f303re.rs"); }
    else if #[cfg(context = "st-nucleo-f401re")] { include!("st-nucleo-f401re.rs"); }
    else if #[cfg(context = "st-nucleo-f411re")] { include!("st-nucleo-f411re.rs"); }
    else if #[cfg(context = "st-nucleo-f767zi")] { include!("st-nucleo-f767zi.rs"); }
    else if #[cfg(context = "st-nucleo-g431rb")] { include!("st-nucleo-g431rb.rs"); }
    else if #[cfg(context = "st-nucleo-h753zi")] { include!("st-nucleo-h753zi.rs"); }
    else if #[cfg(context = "st-nucleo-h755zi-q")] { include!("st-nucleo-h755zi-q.rs"); }
    else if #[cfg(context = "st-nucleo-wb55")] { include!("st-nucleo-wb55.rs"); } else if
